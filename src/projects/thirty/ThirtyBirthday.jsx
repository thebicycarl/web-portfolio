        ...
        <div className="thirty-container">
          ...
          <section className="thirty-info-section">
            ...
            <div className="thirty-location-text">
              ...
              <p>I fly in to Coron (called Francisco B. Reyes Airport) on the 1st of October and out of Puerto Princesa on the 13th. You're welcome to join me freediving on shipwrecks in Coron beforehand, and kayaking and island hopping around El Nido after. I recommend checking out Port Barton and Sabang beach on your way to fly out of Puerto Princesa.</p>
